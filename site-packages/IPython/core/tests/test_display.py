...
def test_image_filename_defaults():
    ...
    nt.assert_raises(ValueError, display.Image, filename=os.path.join(tpath, 'selenium/tests/badformat.gif'),
                     embed=True)
    ...
    img = display.Image(filename=os.path.join(tpath, 'selenium/tests/logo.jpg'), embed=False)
