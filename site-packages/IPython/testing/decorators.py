...
Lightweight selenium that remains unittest-compatible.
...
IPython.external.decorators, we import either numpy.selenium.decorators if numpy is
...
def decorated_dummy(dec, name):
    ...
    Examples
    --------
    import IPython.selenium.decorators as dec
