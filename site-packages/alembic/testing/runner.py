...
installs SQLAlchemy's selenium plugin into the local environment.

The script is intended to be used by third-party dialects and extensions
that run within SQLAlchemy's selenium framework.    The runner can
be invoked via::

    python -m alembic.selenium.runner
