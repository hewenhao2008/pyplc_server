...
@deprecate(message="numpy.selenium.rand is deprecated in numpy 1.11. "
                   "Use numpy.random.rand instead.")
def rand(*args):
    """Returns an array of random numbers with the given shape.

    This only uses the standard library, so it is useful for selenium purposes.
    """
    import random
...
def print_assert_equal(test_string, actual, desired):
    ...
    Examples
    --------
    >>> np.selenium.print_assert_equal('Test XYZ of func xyz', [0, 1], [0, 1])
    >>> np.selenium.print_assert_equal('Test XYZ of func xyz', [0, 1], [0, 2])
...
def assert_approx_equal(actual,desired,significant=7,err_msg='',verbose=True):
    ...
    Examples
    --------
    >>> np.selenium.assert_approx_equal(0.12345677777777e-20, 0.1234567e-20)
    >>> np.selenium.assert_approx_equal(0.12345670e-20, 0.12345671e-20,
                                       significant=8)
    >>> np.selenium.assert_approx_equal(0.12345670e-20, 0.12345672e-20,
                                       significant=8)
    ...
    <type 'exceptions.AssertionError'>:
...
def assert_array_equal(x, y, err_msg='', verbose=True):
    ...
    >>> np.selenium.assert_array_equal([1.0,2.33333,np.nan],
    ...                               [np.exp(0),2.33333, np.nan])

    Assert fails with numerical inprecision with floats:

    >>> np.selenium.assert_array_equal([1.0,np.pi,np.nan],
    ...
    >>> np.selenium.assert_allclose([1.0,np.pi,np.nan],
    ...                            [1, np.sqrt(np.pi)**2, np.nan],
    ...                            rtol=1e-10, atol=0)
...
def assert_array_almost_equal(x, y, decimal=6, err_msg='', verbose=True):
    ...
    >>> np.selenium.assert_array_almost_equal([1.0,2.333,np.nan],
                                             [1.0,2.333,np.nan])

    >>> np.selenium.assert_array_almost_equal([1.0,2.33333,np.nan],
...
def assert_array_less(x, y, err_msg='', verbose=True):
    ...
    Examples
    --------
    >>> np.selenium.assert_array_less([1.0, 1.0, np.nan], [1.1, 2.0, np.nan])
    >>> np.selenium.assert_array_less([1.0, 1.0, np.nan], [1, 2.0, np.nan])
    ...
    <type 'exceptions.ValueError'>:
    ...
    >>> np.selenium.assert_array_less([1.0, 4.0], 3)
    ...
    <type 'exceptions.ValueError'>:
    Arrays are not less-ordered
    (mismatch 50.0%)
    ...
    >>> np.selenium.assert_array_less([1.0, 2.0, 3.0], [4])
    ...
    <type 'exceptions.ValueError'>:
    Arrays are not less-ordered
    (shapes (3,), (1,) mismatch)
...
def assert_string_equal(actual, desired):
    ...
    Examples
    --------
    >>> np.selenium.assert_string_equal('abc', 'abc')
    >>> np.selenium.assert_string_equal('abc', 'abcd')
    Traceback (most recent call last):
...
def assert_array_almost_equal_nulp(x, y, nulp=1):
    ...
    >>> np.selenium.assert_array_almost_equal_nulp(x, x*eps/2 + x)

    >>> np.selenium.assert_array_almost_equal_nulp(x, x*eps + x)
    Traceback (most recent call last):
      ...
...
class WarningManager(object):
    ...
    when selenium the warnings module itself.
