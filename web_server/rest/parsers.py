...
plc_parser.add_argument('station_id', type=int, help='plc从属的station', action='append')
...
group_parser.add_argument('plc_id', type=int, action='append')
...
variable_parser.add_argument('plc_id', type=int, action='append')
variable_parser.add_argument('plc_name', type=str)
variable_parser.add_argument('group_id', type=int, action='append')
...
# todo 四舍五入 保留一位小数   flaot会产生bug (不一定，有可能是输入错误导致的bug）
...
value_parser.add_argument('plc_id', type=int, action='append')
value_parser.add_argument('plc_name', type=str)
value_parser.add_argument('group_id', type=int, action='append')
...
value_parser.add_argument('query_id', type=int, action='append')
value_parser.add_argument('query_name', type=str)
value_parser.add_argument('all_variable_id', type=bool)
value_parser.add_argument('value', type=str)
...
status_parser.add_argument('note', type=str)
...
alarm_now_parser.add_argument('alarm_id', type=int, action='append')
...
alarm_info_parser.add_argument('alarm_type', type=int)
alarm_info_parser.add_argument('note', type=str)
