...
def rp_get(data, page=None, pages=None, total=None, per_page=None):
    count = len(data)
    return make_response(msg='查询成功', status_code=200, data=data, count=count, page=page, pages=pages, total=total, per_page=per_page)
